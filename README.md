...
*   **Latin Square Puzzles**: Solved via true randomized generation with backtracking-verified unique solutions. Features two core modes:
    ...
    *   *Difficulty Configuration*: **Easy, Medium, Hard, Expert**. The selector dynamically scales grid size and determines clue density constraints.
...
*   **Medicine Module**: Organized by critical medical and scientific subjects:
    ...
    *   *Physiology*: Respiratory, nervous system, and endocrine pathways.
    *   *Biology*: Cell biology, genetics, and immunology.
    *   *Biochemistry*: Metabolic pathways and enzymatic reaction kinetics.
...
### 🌍 7. Global Accessibility & Settings
